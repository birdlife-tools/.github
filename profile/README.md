...
|-----------|-------------|--------|
| [birdlife-schema](https://github.com/birdlife-tools/birdlife-schema) | Data contract schemas (Apache Avro) + validation CLI | [![v0.3.7](https://img.shields.io/badge/released-v0.3.7-green)](https://github.com/birdlife-tools/birdlife-schema/releases/tag/v0.3.7) |
...
|------------|-------------|--------|
| [ebird-iucn-synthesizer](https://github.com/birdlife-tools/ebird-iucn-synthesizer) | Synthesize eBird sightings with IUCN Red List threat data | [![v0.1.0](https://img.shields.io/badge/ebird--iucn--synthesizer-v0.1.0-green)](https://github.com/birdlife-tools/ebird-iucn-synthesizer/releases/tag/v0.1.0) |
